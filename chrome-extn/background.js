...
function normalOnClick(info, tab) {
  var newURL = "http://iheartthis.club/new?imageurl="+info.srcUrl+"&pageurl="+info.pageUrl;
  chrome.tabs.create({ url: newURL });
}
function oneClick(info, tab) {
  var newURL = "http://iheartthis.club/fast_new?imageurl="+info.srcUrl+"&pageurl="+info.pageUrl;
  chrome.tabs.create({ url: newURL });
}
